...
@flow(name="Reatraining Pipeline for Drugs prices prediction")
def train_pipeline():

    remote_server_uri = "https://dagshub.com/diego.cotacio/drugs_price_prediction.mlflow"
    mlflow.set_tracking_uri(remote_server_uri)

    experiment_name = "Catboost regressor for drugs prices prediction"
